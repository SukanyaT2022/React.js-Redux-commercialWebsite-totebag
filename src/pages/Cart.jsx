          ...
          <div className="space-y-4">
            <div className="space-y-2">
              <dl className="flex items-center justify-between gap-4">
                <dt className="text-base font-normal text-gray-500 dark:text-gray-400">Mobile</dt>
                <dd className="text-base font-medium text-gray-900 dark:text-white">$800</dd>
              </dl>
              <dl className="flex items-center justify-between gap-4">
                <dt className="text-base font-normal text-gray-500 dark:text-gray-400">Toys</dt>
                <dd className="text-base font-medium text-gray-900 dark:text-white">$200</dd>
              </dl>
            </div>
